...
export default function SignUp() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-4 px-4">
      <h2 className="text-2xl font-semibold">Utwórz konto</h2>
      <p className="text-sm text-gray-500">Dołącz, aby przejąć kontrolę nad swoją finansową przyszłością.</p>
      <div>
      ...
      <p>Zgadzam się z warunkami korzystania z <span className="text-primary"> usługi i polityką prywatności</span>.</p>
      <Button className="w-full cursor-pointer" type="submit">Utwórz konto</Button>
