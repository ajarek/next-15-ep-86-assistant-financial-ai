...
const Dashboard = async () => {
  ...
  return (
    <div className=' flex flex-col items-center justify-start min-h-screen gap-4 px-4 pb-4'>
      ...
      <div className='w-full  grid grid-cols-1 md:grid-cols-2 gap-4 place-items-center'>
        ...
        <ChartPie
          ...
          description='Styczeń-Lipiec 2024'
          text1='W tym miesiącu odnotowano wzrost o 5,2%'
          text2='Wyświetlanie liczby odwiedzających w ciągu 6 miesięcy.'
        />
        <ChartLinear />
      </div>
