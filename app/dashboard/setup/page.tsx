    ...
    <div className=' flex flex-col items-start justify-start h-screen gap-4 px-4'>
      ...
      <div className='w-full flex flex-col gap-4 border-2  rounded-lg p-4 shadow-xl'>
        ...
        <div className='w-full flex  items-center justify-between'>
          ...
          <Link href={'/'} className='bg-primary text-primary-foreground py-2 px-4 rounded-sm '>Edytuj Profil</Link>
        </div>
        <div className='w-full flex  items-center justify-between'>
          <div className='flex items-center gap-4 '>
          ...
          <Link href={'/'} className='bg-primary text-primary-foreground py-2 px-4 rounded-sm '>Subskrypcje</Link>
        </div>
        <div className='w-full flex  items-center justify-between'>
          <div className='flex items-center gap-4 '>
          ...
          <Link href={'/'} className='bg-primary text-primary-foreground py-2 px-4 rounded-sm '>Zmień Hasło</Link>
        </div>
        <div className='w-full flex  items-center justify-between'>
          <div className='flex items-center gap-4 '>
